(() => {
    ...
    function hideNavbarScroll() {
        ...
        if (scrollOne > scrollTwo || scrollTwo < 70) document.querySelector(".header").classList.remove("header-scroll"); else document.querySelector(".header").classList.add("header-scroll");
        scrollOne = scrollTwo;
    }
